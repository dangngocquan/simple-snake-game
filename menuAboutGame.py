...
class AboutGameMenu:
    ...
    def __init__(self, x, y, width, height):
        ...
        self.titleLinkMusic01 = Button("MUSIC 0: BoyWithUke - Loafers", DESCRIPTION_FONT_2, width//8, height*3//24, 'topLeft')
        self.titleLinkMusic02 = Button("MUSIC 1: Sweden - C418", DESCRIPTION_FONT_2, width//8, height*4//24, 'topLeft')
